...
data class ${templateModel.RestApiTransferObjectName}(
    ...
    companion object {
        internal fun fromDomain(domainInstance: ${templateModel.KotlinModelClassName}) = ${templateModel.RestApiTransferObjectName}(
